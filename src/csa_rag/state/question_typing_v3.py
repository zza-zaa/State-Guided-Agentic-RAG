...
def infer_question_type_v3(question: str) -> QuestionTypeSpec:
    q = _norm(question)
    ...
    elif "what position" in q or "which professional ice hockey position" in q:
    ...
    elif "which country" in q or "what nationality" in q or "what country" in q:
